...
public class EntityUnicorn extends EntityHorse {
    ...
    private static final String[] HORSE_TEXTURES = new String[] {"textures/entity/unicorn/unicorn.png"};
    private static final String[] HORSE_TEXTURES_ABBR = new String[] {"uni"}; // Abkürzungen für die 'Pferde'texturen.
    private static final String[] HORSE_MARKING_TEXTURES = new String[] {null}; // Hier können noch Markierungen definiert werden. (Sternchen etc. für Unicorns?)
    private static final String[] HORSE_MARKING_TEXTURES_ABBR = new String[] {""}; // Und die Abkürzungen für die Markierungen.
