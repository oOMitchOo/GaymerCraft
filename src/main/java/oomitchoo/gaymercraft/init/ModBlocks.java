...
public class ModBlocks {
    ...
    // underwater plants
    public static final Block RAINBOW_KELP = new RainbowKelpTopBlock(Block.Properties.create(Material.OCEAN_PLANT).doesNotBlockMovement().tickRandomly().hardnessAndResistance(0.0F).sound(SoundType.WET_GRASS)).setRegistryName(Reference.MOD_ID, "rainbow_kelp");
    public static final Block RAINBOW_KELP_PLANT = new RainbowKelpBlock((RainbowKelpTopBlock)RAINBOW_KELP, Block.Properties.create(Material.OCEAN_PLANT).doesNotBlockMovement().hardnessAndResistance(0.0F).sound(SoundType.WET_GRASS)).setRegistryName(Reference.MOD_ID, "rainbow_kelp_plant");
    public static final Block RAINBOW_SEAGRASS = new RainbowSeaGrassBlock(Block.Properties.create(Material.SEA_GRASS).doesNotBlockMovement().hardnessAndResistance(0.0F).sound(SoundType.WET_GRASS)).setRegistryName(Reference.MOD_ID, "rainbow_seagrass");
    public static final Block RAINBOW_TALL_SEAGRASS = new RainbowTallSeaGrassBlock(Block.Properties.create(Material.SEA_GRASS).doesNotBlockMovement().hardnessAndResistance(0.0F).sound(SoundType.WET_GRASS)).setRegistryName(Reference.MOD_ID, "rainbow_tall_seagrass");
    public static final Block RAINBOW_SEA_PICKLE = new RainbowSeaPickleBlock(Block.Properties.create(Material.OCEAN_PLANT, MaterialColor.GREEN).lightValue(3).sound(SoundType.SLIME)).setRegistryName(Reference.MOD_ID, "rainbow_sea_pickle");
    public static final Block RAINBOW_DEAD_TUBE_CORAL = new RainbowDeadCoralPlantBlock(Block.Properties.create(Material.ROCK, MaterialColor.GRAY).doesNotBlockMovement().hardnessAndResistance(0.0F)).setRegistryName(Reference.MOD_ID, "rainbow_dead_tube_coral");
    public static final Block RAINBOW_DEAD_BRAIN_CORAL = new RainbowDeadCoralPlantBlock(Block.Properties.create(Material.ROCK, MaterialColor.GRAY).doesNotBlockMovement().hardnessAndResistance(0.0F)).setRegistryName(Reference.MOD_ID, "rainbow_dead_brain_coral");
    public static final Block RAINBOW_DEAD_BUBBLE_CORAL = new RainbowDeadCoralPlantBlock(Block.Properties.create(Material.ROCK, MaterialColor.GRAY).doesNotBlockMovement().hardnessAndResistance(0.0F)).setRegistryName(Reference.MOD_ID, "rainbow_dead_bubble_coral");
    public static final Block RAINBOW_DEAD_FIRE_CORAL = new RainbowDeadCoralPlantBlock(Block.Properties.create(Material.ROCK, MaterialColor.GRAY).doesNotBlockMovement().hardnessAndResistance(0.0F)).setRegistryName(Reference.MOD_ID, "rainbow_dead_fire_coral");
    public static final Block RAINBOW_DEAD_HORN_CORAL = new RainbowDeadCoralPlantBlock(Block.Properties.create(Material.ROCK, MaterialColor.GRAY).doesNotBlockMovement().hardnessAndResistance(0.0F)).setRegistryName(Reference.MOD_ID, "rainbow_dead_horn_coral");
    public static final Block RAINBOW_TUBE_CORAL = new RainbowCoralPlantBlock(RAINBOW_DEAD_TUBE_CORAL, Block.Properties.create(Material.OCEAN_PLANT, MaterialColor.BLUE).doesNotBlockMovement().hardnessAndResistance(0.0F).sound(SoundType.WET_GRASS)).setRegistryName(Reference.MOD_ID, "rainbow_tube_coral");
    public static final Block RAINBOW_BRAIN_CORAL = new RainbowCoralPlantBlock(RAINBOW_DEAD_BRAIN_CORAL, Block.Properties.create(Material.OCEAN_PLANT, MaterialColor.PINK).doesNotBlockMovement().hardnessAndResistance(0.0F).sound(SoundType.WET_GRASS)).setRegistryName(Reference.MOD_ID, "rainbow_brain_coral");
    public static final Block RAINBOW_BUBBLE_CORAL = new RainbowCoralPlantBlock(RAINBOW_DEAD_BUBBLE_CORAL, Block.Properties.create(Material.OCEAN_PLANT, MaterialColor.PURPLE).doesNotBlockMovement().hardnessAndResistance(0.0F).sound(SoundType.WET_GRASS)).setRegistryName(Reference.MOD_ID, "rainbow_bubble_coral");
    public static final Block RAINBOW_FIRE_CORAL = new RainbowCoralPlantBlock(RAINBOW_DEAD_FIRE_CORAL, Block.Properties.create(Material.OCEAN_PLANT, MaterialColor.RED).doesNotBlockMovement().hardnessAndResistance(0.0F).sound(SoundType.WET_GRASS)).setRegistryName(Reference.MOD_ID, "rainbow_fire_coral");
    public static final Block RAINBOW_HORN_CORAL = new RainbowCoralPlantBlock(RAINBOW_DEAD_HORN_CORAL, Block.Properties.create(Material.OCEAN_PLANT, MaterialColor.YELLOW).doesNotBlockMovement().hardnessAndResistance(0.0F).sound(SoundType.WET_GRASS)).setRegistryName(Reference.MOD_ID, "rainbow_horn_coral");
    public static final Block RAINBOW_DEAD_TUBE_CORAL_FAN = new RainbowCoralFanBlock(Block.Properties.create(Material.ROCK, MaterialColor.GRAY).doesNotBlockMovement().hardnessAndResistance(0.0F)).setRegistryName(Reference.MOD_ID, "rainbow_dead_tube_coral_fan");
    public static final Block RAINBOW_DEAD_BRAIN_CORAL_FAN = new RainbowCoralFanBlock(Block.Properties.create(Material.ROCK, MaterialColor.GRAY).doesNotBlockMovement().hardnessAndResistance(0.0F)).setRegistryName(Reference.MOD_ID, "rainbow_dead_brain_coral_fan");
    public static final Block RAINBOW_DEAD_BUBBLE_CORAL_FAN = new RainbowCoralFanBlock(Block.Properties.create(Material.ROCK, MaterialColor.GRAY).doesNotBlockMovement().hardnessAndResistance(0.0F)).setRegistryName(Reference.MOD_ID, "rainbow_dead_bubble_coral_fan");
    public static final Block RAINBOW_DEAD_FIRE_CORAL_FAN = new RainbowCoralFanBlock(Block.Properties.create(Material.ROCK, MaterialColor.GRAY).doesNotBlockMovement().hardnessAndResistance(0.0F)).setRegistryName(Reference.MOD_ID, "rainbow_dead_fire_coral_fan");
    public static final Block RAINBOW_DEAD_HORN_CORAL_FAN = new RainbowCoralFanBlock(Block.Properties.create(Material.ROCK, MaterialColor.GRAY).doesNotBlockMovement().hardnessAndResistance(0.0F)).setRegistryName(Reference.MOD_ID, "rainbow_dead_horn_coral_fan");
    public static final Block RAINBOW_TUBE_CORAL_FAN = new RainbowCoralFinBlock(RAINBOW_DEAD_TUBE_CORAL_FAN, Block.Properties.create(Material.OCEAN_PLANT, MaterialColor.BLUE).doesNotBlockMovement().hardnessAndResistance(0.0F).sound(SoundType.WET_GRASS)).setRegistryName(Reference.MOD_ID, "rainbow_tube_coral_fan");
    public static final Block RAINBOW_BRAIN_CORAL_FAN = new RainbowCoralFinBlock(RAINBOW_DEAD_BRAIN_CORAL_FAN, Block.Properties.create(Material.OCEAN_PLANT, MaterialColor.PINK).doesNotBlockMovement().hardnessAndResistance(0.0F).sound(SoundType.WET_GRASS)).setRegistryName(Reference.MOD_ID, "rainbow_brain_coral_fan");
    public static final Block RAINBOW_BUBBLE_CORAL_FAN = new RainbowCoralFinBlock(RAINBOW_DEAD_BUBBLE_CORAL_FAN, Block.Properties.create(Material.OCEAN_PLANT, MaterialColor.PURPLE).doesNotBlockMovement().hardnessAndResistance(0.0F).sound(SoundType.WET_GRASS)).setRegistryName(Reference.MOD_ID, "rainbow_bubble_coral_fan");
    public static final Block RAINBOW_FIRE_CORAL_FAN = new RainbowCoralFinBlock(RAINBOW_DEAD_FIRE_CORAL_FAN, Block.Properties.create(Material.OCEAN_PLANT, MaterialColor.RED).doesNotBlockMovement().hardnessAndResistance(0.0F).sound(SoundType.WET_GRASS)).setRegistryName(Reference.MOD_ID, "rainbow_fire_coral_fan");
    public static final Block RAINBOW_HORN_CORAL_FAN = new RainbowCoralFinBlock(RAINBOW_DEAD_HORN_CORAL_FAN, Block.Properties.create(Material.OCEAN_PLANT, MaterialColor.YELLOW).doesNotBlockMovement().hardnessAndResistance(0.0F).sound(SoundType.WET_GRASS)).setRegistryName(Reference.MOD_ID, "rainbow_horn_coral_fan");
    public static final Block RAINBOW_DEAD_TUBE_CORAL_WALL_FAN = new RainbowDeadCoralWallFanBlock(Block.Properties.create(Material.ROCK, MaterialColor.GRAY).doesNotBlockMovement().hardnessAndResistance(0.0F).lootFrom(RAINBOW_DEAD_TUBE_CORAL_FAN)).setRegistryName(Reference.MOD_ID, "rainbow_dead_tube_coral_wall_fan");
    public static final Block RAINBOW_DEAD_BRAIN_CORAL_WALL_FAN = new RainbowDeadCoralWallFanBlock(Block.Properties.create(Material.ROCK, MaterialColor.GRAY).doesNotBlockMovement().hardnessAndResistance(0.0F).lootFrom(RAINBOW_DEAD_BRAIN_CORAL_FAN)).setRegistryName(Reference.MOD_ID, "rainbow_dead_brain_coral_wall_fan");
    public static final Block RAINBOW_DEAD_BUBBLE_CORAL_WALL_FAN = new RainbowDeadCoralWallFanBlock(Block.Properties.create(Material.ROCK, MaterialColor.GRAY).doesNotBlockMovement().hardnessAndResistance(0.0F).lootFrom(RAINBOW_DEAD_BUBBLE_CORAL_FAN)).setRegistryName(Reference.MOD_ID, "rainbow_dead_bubble_coral_wall_fan");
    public static final Block RAINBOW_DEAD_FIRE_CORAL_WALL_FAN = new RainbowDeadCoralWallFanBlock(Block.Properties.create(Material.ROCK, MaterialColor.GRAY).doesNotBlockMovement().hardnessAndResistance(0.0F).lootFrom(RAINBOW_DEAD_FIRE_CORAL_FAN)).setRegistryName(Reference.MOD_ID, "rainbow_dead_fire_coral_wall_fan");
    public static final Block RAINBOW_DEAD_HORN_CORAL_WALL_FAN = new RainbowDeadCoralWallFanBlock(Block.Properties.create(Material.ROCK, MaterialColor.GRAY).doesNotBlockMovement().hardnessAndResistance(0.0F).lootFrom(RAINBOW_DEAD_HORN_CORAL_FAN)).setRegistryName(Reference.MOD_ID, "rainbow_dead_horn_coral_wall_fan");
    public static final Block RAINBOW_TUBE_CORAL_WALL_FAN = new RainbowCoralWallFanBlock(RAINBOW_DEAD_TUBE_CORAL_WALL_FAN, Block.Properties.create(Material.OCEAN_PLANT, MaterialColor.BLUE).doesNotBlockMovement().hardnessAndResistance(0.0F).sound(SoundType.WET_GRASS).lootFrom(RAINBOW_TUBE_CORAL_FAN)).setRegistryName(Reference.MOD_ID, "rainbow_tube_coral_wall_fan");
    public static final Block RAINBOW_BRAIN_CORAL_WALL_FAN = new RainbowCoralWallFanBlock(RAINBOW_DEAD_BRAIN_CORAL_WALL_FAN, Block.Properties.create(Material.OCEAN_PLANT, MaterialColor.PINK).doesNotBlockMovement().hardnessAndResistance(0.0F).sound(SoundType.WET_GRASS).lootFrom(RAINBOW_BRAIN_CORAL_FAN)).setRegistryName(Reference.MOD_ID, "rainbow_brain_coral_wall_fan");
    public static final Block RAINBOW_BUBBLE_CORAL_WALL_FAN = new RainbowCoralWallFanBlock(RAINBOW_DEAD_BUBBLE_CORAL_WALL_FAN, Block.Properties.create(Material.OCEAN_PLANT, MaterialColor.PURPLE).doesNotBlockMovement().hardnessAndResistance(0.0F).sound(SoundType.WET_GRASS).lootFrom(RAINBOW_BUBBLE_CORAL_FAN)).setRegistryName(Reference.MOD_ID, "rainbow_bubble_coral_wall_fan");
    public static final Block RAINBOW_FIRE_CORAL_WALL_FAN = new RainbowCoralWallFanBlock(RAINBOW_DEAD_FIRE_CORAL_WALL_FAN, Block.Properties.create(Material.OCEAN_PLANT, MaterialColor.RED).doesNotBlockMovement().hardnessAndResistance(0.0F).sound(SoundType.WET_GRASS).lootFrom(RAINBOW_FIRE_CORAL_FAN)).setRegistryName(Reference.MOD_ID, "rainbow_fire_coral_wall_fan");
    public static final Block RAINBOW_HORN_CORAL_WALL_FAN = new RainbowCoralWallFanBlock(RAINBOW_DEAD_HORN_CORAL_WALL_FAN, Block.Properties.create(Material.OCEAN_PLANT, MaterialColor.YELLOW).doesNotBlockMovement().hardnessAndResistance(0.0F).sound(SoundType.WET_GRASS).lootFrom(RAINBOW_HORN_CORAL_FAN)).setRegistryName(Reference.MOD_ID, "rainbow_horn_coral_wall_fan");
}
