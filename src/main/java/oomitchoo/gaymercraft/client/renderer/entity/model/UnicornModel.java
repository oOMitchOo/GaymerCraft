package oomitchoo.gaymercraft.client.renderer.entity.model;
...
// todo: This has to get totally reworked (with HorseRenderer in mind)
public class UnicornModel extends EntityModel<UnicornEntity> {
    private final RendererModel head;
    // START horn
    private final RendererModel hornThick;
    private final RendererModel hornMiddle;
    private final RendererModel hornThin;
    // END horn
    ...
    public UnicornModel()
    {
        ...
        // START horn
        this.hornThick = new RendererModel(this, 68, 58);
        this.hornThick.addBox(-1.5F, -11.5F, 0.0F, 3, 2, 3);
        this.hornThick.setRotationPoint(0.0F, 4.0F, -10.0F);
        this.hornThick.rotateAngleX = 0.5235988F;
        this.hornMiddle = new RendererModel(this, 80, 58);
        this.hornMiddle.addBox(-1.0F, -14.5F, 0.5F, 2, 3, 2);
        this.hornThick.setRotationPoint(0.0F, 4.0F, -10.0F);
        this.hornThick.rotateAngleX = 0.5235988F;
        this.hornThin = new RendererModel(this, 88, 58);
     ...
     */
    @Override
    public void render(UnicornEntity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scale)
    {
        ...
        if (flag1) // If the horse has a saddle on.
        {
            ...
            if (flag4) // Wenn jemand das Pferd reitet (Die Zügel).
            {
        ...
        if (flag3) // Kein Fohlen, kann Truhe haben UND hat Truhe.
        {
     ...
     */
    @Override
    public void setLivingAnimations(UnicornEntity entitylivingbaseIn, float limbSwing, float limbSwingAmount, float partialTickTime)
    {
        ...
        this.hornThick.rotateAngleY = this.head.rotateAngleY;
        this.hornMiddle.rotationPointY = this.head.rotationPointY;
        this.hornMiddle.rotationPointZ = this.head.rotationPointZ;
        this.hornMiddle.rotateAngleX = this.head.rotateAngleX;
        this.hornMiddle.rotateAngleY = this.head.rotateAngleY;
        this.hornThin.rotationPointY = this.head.rotationPointY;
